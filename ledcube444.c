...
__code uint8_t
    tabP0[38][8] = {{0x00, 0x60, 0x60, 0x00, 0x00, 0x60, 0x60, 0x00}};

//扫描 - scanning
__code uint8_t tabP2[] = {0xFE, 0xFD, 0xFB, 0xF7, 0xEF, 0xDF, 0xBF, 0x7F};

 //中间四个 - four intermediate
__code uint8_t PWMsz[8] = {0x00, 0x60, 0x60, 0x00, 0x00, 0x60, 0x60, 0x00};
...
void init() {
  ...
  // 6 preset initial value is written to timer 0, so that 250 microseconds
  // overflow once (12MHz)
...
void alllighttooff() {
  __code uint8_t
      tabP0[8][8] = {{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF},
...
void randomlight() {
  __code uint8_t
      tabP0[38][8] = {{0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
void allfalloff() {
  __code uint8_t
      tabP0[4][8] = {{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF},
...
void turnR() {
  __code uint8_t
      tabP0[6][8] = {{0x00, 0x00, 0x0F, 0xF0, 0x00, 0x00, 0x00, 0xFF},
...
void righttoleft() {
  __code uint8_t
      tabP0[4][8] = {{0x00, 0x00, 0x00, 0x00, 0x0F, 0x0F, 0x0F, 0x0F},
...
void lefttoright() {
  __code uint8_t
      tabP0[4][8] = {{0x0F, 0x0F, 0x0F, 0x0F, 0x00, 0x00, 0x00, 0x00},
                     {0xF0, 0xF0, 0xF0, 0xF0, 0x00, 0x00, 0x00, 0x00},
                     {0x00, 0x00, 0x00, 0x00, 0xF0, 0xF0, 0xF0, 0xF0},
                     {0x00, 0x00, 0x00, 0x00, 0x0F, 0x0F, 0x0F, 0x0F}};
  int j, k, i;
...
void turnD() {
  __code uint8_t
      tabP0[6][8] = {{0x00, 0x00, 0x00, 0x00, 0xF0, 0x0F, 0x0F, 0x0F},
                     {0xF0, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x0F, 0x0F},
                     {0x0F, 0xF0, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x0F},
                     {0x00, 0x0F, 0xF0, 0x00, 0x00, 0x00, 0x00, 0xFF},
...
void Thenthelast() {
  __code uint8_t
      tabP0[3][8] = {{0x00, 0x48, 0x48, 0x48, 0x00, 0x21, 0x21, 0x21},
                     {0x00, 0x00, 0x48, 0x48, 0x00, 0x00, 0x21, 0x21},
                     {0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00, 0x21}};
  int j, k, i;
  for (j = 0; j < 3; j++) {
...
/** 左上1开始 三个走 最后 底层亮完 - 1 starts last three go left bottom bright
 * finish */
void twoidea() //
{
...
void around2() {
  __code uint8_t
      tabP0[27][8] = {{0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00},
...
/** 第一种接框架后 4个小正方形转动最后全亮
    4 small square full brightness after the final rotation of the first
   connection frame */
void nextkj1() {
...
/** 最前面一面全亮开始 围着光立方转 最后回到第一面
    Front side all light began to turn around last light cube back to the first
   surface */
void around() {
  __code uint8_t
      tabP0[12][8] = {{0x13, 0x13, 0x13, 0x13, 0x10, 0x10, 0x10, 0x10},
...
/** 接Around 第一面转到第一列 - Around the first contact surface to the first
 * column */
void aroundnext() {
...
void rain() {
  __code uint8_t
      tabP0[40][8] = {{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                      {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
void fourspread() {
  __code uint8_t
      tabP0[12][8] = {{0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                      {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                      {0x33, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
Cube slowly from the middle of the bottom up to the top of a small spread next
to the bottom */
void any2() {
  __code uint8_t tabP0[8][8] = {
      {0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x60},
...
/** 右上一个小正方体 绕绕绕到左上 - Upper right around a small cube around the
 * wound left */
void any4() {
  __code uint8_t
      tabP0[21][8] = {{0x00, 0x00, 0x00, 0x00, 0x8C, 0x88, 0x00, 0x00},
...
void any6() {
  __code uint8_t
      tabP0[9][8] = {{0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00, 0xC2},
...
void any7() {
  __code uint8_t
      tabP0[20][8] = {{0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0xFF},
                      {0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF},
                      {0x00, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0xFF},
                      {0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF},
                      {0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0xFF},
...
void any8() {
  __code uint8_t
      tabP0[25][8] = {{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01},
...
/** 由上面一排全亮  转到左上小正方形 - All lit from the top row left to a small
 * square */
void any9() {
